...
impl Cmd {
    fn as_str(&self) -> &str {
        ...
        match self {
            ...
            About => "About",
            Path => "Show file path",
            RelativePath => "Show file path relative to project root",
            ...
            OpenWorkspaceConfig => "Open workspace config",
